...
CHECKPOINT_ROOT="${CHECKPOINT_ROOT:-checkpoints/robocerebra/GR00T-RC-CTR-search/R0-residual-v9-outcome-first-balanced}"
OPTION_REGISTRY="${OPTION_REGISTRY:-artifacts/Ours/search/R0-residual-v9-outcome-first-balanced/residual_registry.json}"
