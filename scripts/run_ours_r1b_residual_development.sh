...
OUTPUT_ROOT="${OUTPUT_ROOT:-artifacts/Ours/development/R1b-residual-v8}"
CHECKPOINT_ROOT="${CHECKPOINT_ROOT:-checkpoints/robocerebra/GR00T-RC-CTR-search/R0-residual-v8-confirmed}"
OPTION_REGISTRY="${OPTION_REGISTRY:-artifacts/Ours/search/R0-residual-v8-confirmed/residual_registry.json}"
