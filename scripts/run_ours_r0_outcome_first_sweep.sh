...
export CHECKPOINT_ROOT="checkpoints/robocerebra/GR00T-RC-CTR-search/R0-residual-v9-outcome-first-balanced"
export ARTIFACT_ROOT="artifacts/Ours/search/R0-residual-v9-outcome-first-balanced"
